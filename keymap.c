...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(ESC,  1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   BSPC, \
           ...
           LCTL, LGUI,FN3, LALT, FN1, FN2,     FN8, FN4,LEFT,DOWN,RIGHT),
    ...
    KEYMAP( GRV,   F1,   F2,   F3,   F4,   F5,   F6,   F7,   F8,   F9,  F10,  DEL, \
           ...
           TRNS, TRNS, TRNS, TRNS, TRNS, TRNS,       TRNS, RCTL, TRNS, TRNS, FN7),
    ...
    //Game mode, makes space bar hold-able
    ...
    //Vim mode
    KEYMAP(TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, \
           TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS,  FN9, TRNS, TRNS, TRNS, TRNS, \
           TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, LEFT, DOWN,   UP,RIGHT, TRNS, TRNS, \
           TRNS, TRNS,  DEL, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, \
           TRNS, TRNS, TRNS, TRNS, TRNS, TRNS,       TRNS, TRNS, TRNS, TRNS, TRNS),
...
const action_t PROGMEM fn_actions[] = {
  ...
  [6] = ACTION_MACRO(RCB),
  [7] = ACTION_MACRO(LEFT),
  [8] = ACTION_LAYER_TOGGLE(4), //Vim mode
  [9] = ACTION_MACRO(UNDO),
};
